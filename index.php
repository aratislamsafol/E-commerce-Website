	...
	<section class="intel-catagory p-4">
		...
		?>
			...
			<div class="item">
				...
				<div class="card-img">
					<figure>
					<img class="card-img-top" src="http://www.binarylogic.com.bd/wp-content/uploads/2020/08/Avengers_Tristan_Eaton_i9_Left_Top_Down_GRAD_BKG-300x300.png" class="latest-product-image" alt="Card image cap"/>
				</figure>
				<div class="card-icon1">
					<span><i class="fas fa-heart"></i></span>
				...
				<div class="card-body text-center">
					<h5 class="card-title">Core i9</h5>
					<p class="card-text">Intel Core i9-10850K 3.6 GHz Ten-Core LGA 1200</p>
					<a href="#" class="btn btn-primary">Details</a>
				</div>
				</div>
            </div> 
			<div class="item">
				...
				<div class="card-img">
					<figure>
					<img class="card-img-top" src="http://www.binarylogic.com.bd/wp-content/uploads/2020/08/Avengers_Tristan_Eaton_i5_Left_Top_Down_GRAD_BKG-300x300.jpg" class="latest-product-image" alt="Card image cap"/>
				</figure>
				<div class="card-icon1">
					<span><i class="fas fa-heart"></i></span>
				...
				<div class="card-body text-center">
					<h5 class="card-title">Core i5</h5>
					<p class="card-text">
						Intel® Core™ i5-1185G7 Processor (12M Cache, up to 4.80 GHz)
					</p>
					<a href="#" class="btn btn-primary">Details</a>
				</div>
				</div>
